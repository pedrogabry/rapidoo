...
export default function Restaurante({ route }) {
  ...
  if(!restaurante){
    ...
    const categorias = [
      "Todos",
      ...Object.keys(restaurante.cardapio || {})
    ];
    const produtos = Object.entries(restaurante.cardapio || {})
    .flatMap(([categoria, itens]) =>
  ...
  return (
      <ScrollView style={styles.container}>
        ...
        <View>
          <Image
            source={{ uri: restaurante.baner }}
            style={styles.banner}
          />

          <Image
            source={{ uri: restaurante.logo }}
            style={styles.logo}
          />
        </View>
